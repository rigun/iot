...
<nav>
    ...
    <ul class="nav">
      ...
      <li><a href="#"><i class="icon-wrench" style="color:#17619D"></i></a></li>
    </ul>
    <ul class="nav">
      <li><a href="#"><i class="icon-copy" style="color:#174A57"></i></a></li>
      <li><a href="#"><i class="icon-cogs" style="color:#F8B50E"></i></a></li>
    </ul>
  </nav>
</div>
</template>
